...
.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.btn-viewer-action):not(.btn-icon-only):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark) {{
...
.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.btn-viewer-action):not(.btn-icon-only):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark):hover {{
    background-color: {btnHoverBg} !important;
    border-color: {btnHoverBorder} !important;
    color: #ffffff !important;
}}

.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.btn-viewer-action):not(.btn-icon-only):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark):active,
.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.btn-viewer-action):not(.btn-icon-only):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark):focus {{
    background-color: {btnActiveBg} !important;
    border-color: {iconColor} !important;
    color: #ffffff !important;
}}

.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.btn-viewer-action):not(.btn-icon-only):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark):hover .btn-icon:not(.icon-danger):not(.icon-white):not(.icon-dark):not(.icon-success),
.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.btn-viewer-action):not(.btn-icon-only):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark):active .btn-icon:not(.icon-danger):not(.icon-white):not(.icon-dark):not(.icon-success),
.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.btn-viewer-action):not(.btn-icon-only):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark):focus .btn-icon:not(.icon-danger):not(.icon-white):not(.icon-dark):not(.icon-success) {{
...
.custom-nav-link .nav-icon {{
    filter: url(#theme-icon-filter) !important;
}}
...
.btn:not(.btn-danger):not(.btn-outline-danger):not(.btn-warning):not(.btn-outline-warning):not(.media-btn-upload):not(.btn-success):not(.btn-outline-success):not(.media-btn-open):not(.btn-dark):not(.btn-outline-dark):not(:hover):not(:active) .btn-icon:not(.icon-danger):not(.icon-white):not(.icon-dark):not(.icon-success) {{
    filter: url(#theme-icon-filter) !important;
}}

/* Strictly protect red buttons, text and icons */
.btn-danger,
.btn-outline-danger,
.media-btn-delete,
.btn-viewer-delete {{
...
.btn-outline-danger:focus {{
    color: #ffffff !important;
    background-color: #6a0b0b !important;
    border-color: #9e1414 !important;
}}

.btn-danger .btn-icon,
.btn-outline-danger .btn-icon,
.media-btn-delete .btn-icon,
.btn-viewer-delete img,
.icon-danger {{
    filter: var(--filter-danger) !important;
}}

.btn-danger:hover .btn-icon,
.btn-outline-danger:hover .btn-icon,
.media-btn-delete:hover .btn-icon,
.btn-viewer-delete:hover img {{
    filter: var(--filter-white) !important;
}}

/* Strictly protect upload (green) buttons, text and icons */
.media-btn-upload,
.btn-success,
.btn-outline-success,
.btn-viewer-upload {{
    background-color: #0b3d16 !important;
    border-color: #125e22 !important;
    color: #ffffff !important;
}}
...
.btn-viewer-upload:hover {{
    background-color: #125e22 !important;
    border-color: #1a822f !important;
    color: #ffffff !important;
}}

.media-btn-upload .btn-icon,
.btn-success .btn-icon,
.btn-outline-success .btn-icon,
.media-btn-upload img,
.btn-viewer-upload img {{
    filter: var(--filter-white) !important;
}}

/* Strictly protect view (dark) buttons, text and icons */
.media-btn-open,
.btn-dark,
.btn-outline-dark {{
    background-color: #07242B !important;
    border-color: #0d4b59 !important;
    color: #ffffff !important;
}}

.media-btn-open:hover,
.btn-dark:hover,
.btn-outline-dark:hover {{
    background-color: #0A3540 !important;
    border-color: #136173 !important;
    color: #ffffff !important;
}}

.media-btn-open .btn-icon,
.btn-dark .btn-icon,
...
/* Strictly preserve personal profile name unchanged as before */
.nav-profile-name {{
    color: #ffffff !important;
    text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.9), 0 0 4px rgba(0, 0, 0, 0.8) !important;
}}

.text-self-user,
.picflow-label.text-accent,
.picflow-label.text-self-user {{
    color: #6ae3f9 !important;
}}

/* Image Viewer Theme Integration */
.image-viewer-bottom-bar {{
    background: rgba(10, 14, 18, 0.85) !important;
    border: 2px solid {btnBorder} !important;
    box-shadow: 0 8px 30px rgba(0, 0, 0, 0.7), 0 0 16px rgba({rgb.r}, {rgb.g}, {rgb.b}, 0.25) !important;
}}

/* Close button (X), navigation arrows, and action buttons in resting state */
.btn-viewer-close,
.btn-nav,
.btn-viewer-action:not(.btn-danger):not(.btn-success):not(.btn-viewer-delete):not(.btn-viewer-upload) {{
    background-color: {btnBg} !important;
    border: 2px solid {btnBorder} !important;
    opacity: 1 !important;
}}

/* Icons in resting state */
.btn-viewer-close img,
.btn-nav img,
.btn-viewer-action:not(.btn-viewer-delete):not(.btn-viewer-upload) img:not(.icon-danger):not(.icon-success) {{
    filter: url(#theme-icon-filter) !important;
}}
...
.btn-nav:hover,
.btn-viewer-action:not(.btn-danger):not(.btn-success):not(.btn-viewer-delete):not(.btn-viewer-upload):hover {{
    background-color: {btnHoverBg} !important;
    border-color: {iconColor} !important;
    box-shadow: 0 0 12px rgba({rgb.r}, {rgb.g}, {rgb.b}, 0.5) !important;
}}

.btn-viewer-close:hover img,
.btn-nav:hover img,
.btn-viewer-action:not(.btn-viewer-delete):not(.btn-viewer-upload):hover img:not(.icon-danger):not(.icon-success) {{
    filter: var(--filter-white) !important;
}}

/* Active action button state (e.g. Info Panel open) */
.btn-viewer-action.active {{
    background-color: {btnActiveBg} !important;
    border-color: {iconColor} !important;
    box-shadow: 0 0 14px rgba({rgb.r}, {rgb.g}, {rgb.b}, 0.6) !important;
}}

.btn-viewer-action.active img:not(.icon-danger):not(.icon-success) {{
    filter: var(--filter-white) !important;
}}
