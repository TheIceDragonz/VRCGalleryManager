...
namespace VRChat.API.Api
{
    ...
    public interface IPrintsApiSync : IApiAccessor
    {
        ...
        List<Print> GetUserPrints(string userId, int? limit = default(int?), int? offset = default(int?));
        ...
        ApiResponse<List<Print>> GetUserPrintsWithHttpInfo(string userId, int? limit = default(int?), int? offset = default(int?));
        /// <summary>
        /// Upload Print
        /// </summary>
        /// <remarks>
    ...
    public interface IPrintsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Print>> GetUserPrintsAsync(string userId, int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Print>>> GetUserPrintsWithHttpInfoAsync(string userId, int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Upload Print
        /// </summary>
        /// <remarks>
    ...
    public partial class PrintsApi : IDisposable, IPrintsApi
    {
        ...
        public List<Print> GetUserPrints(string userId, int? limit = default(int?), int? offset = default(int?))
        {
            VRChat.API.Client.ApiResponse<List<Print>> localVarResponse = GetUserPrintsWithHttpInfo(userId, limit, offset);
            return localVarResponse.Data;
        }
        ...
        /// <param name="userId">Must be a valid user ID.</param>
        /// <returns>ApiResponse of List&lt;Print&gt;</returns>
        public VRChat.API.Client.ApiResponse<List<Print>> GetUserPrintsWithHttpInfo(string userId) => GetUserPrintsWithHttpInfo(userId, null, null);

        public VRChat.API.Client.ApiResponse<List<Print>> GetUserPrintsWithHttpInfo(string userId, int? limit = default(int?), int? offset = default(int?))
        {
            if (userId == null) throw new ApiException(400, "Missing userId");

            VRChat.API.Client.RequestOptions localVarRequestOptions = new VRChat.API.Client.RequestOptions();

            // FIX: VRChat API uses 'n' instead of 'limit', the SDK generator incorrectly mapped it
            if (limit != null) localVarRequestOptions.QueryParameters.Add(VRChat.API.Client.ClientUtils.ParameterToMultiMap("", "n", limit));
            if (offset != null) localVarRequestOptions.QueryParameters.Add(VRChat.API.Client.ClientUtils.ParameterToMultiMap("", "offset", offset));
            ...
            return this.Client.Get<List<Print>>("/prints/user/{userId}", localVarRequestOptions, this.Configuration);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Print&gt;</returns>
        public async System.Threading.Tasks.Task<List<Print>> GetUserPrintsAsync(string userId, int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default)
        {
            VRChat.API.Client.ApiResponse<List<Print>> localVarResponse = await GetUserPrintsWithHttpInfoAsync(userId, limit, offset, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

        public System.Threading.Tasks.Task<ApiResponse<List<Print>>> GetUserPrintsWithHttpInfoAsync(string userId, System.Threading.CancellationToken cancellationToken = default)
            => GetUserPrintsWithHttpInfoAsync(userId, null, null, cancellationToken);

        public async System.Threading.Tasks.Task<ApiResponse<List<Print>>> GetUserPrintsWithHttpInfoAsync(string userId, int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default)
        {
            if (userId == null) throw new ApiException(400, "Missing userId");
            ...
            localVarRequestOptions.PathParameters.Add("userId", userId);

            if (!string.IsNullOrEmpty(this.Configuration.GetApiKeyWithPrefix("auth")))
                localVarRequestOptions.Cookies.Add(new Cookie("auth", this.Configuration.GetApiKeyWithPrefix("auth"), "/", "api.vrchat.cloud"));

            return await this.AsynchronousClient.GetAsync<List<Print>>("/prints/user/{userId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        }
