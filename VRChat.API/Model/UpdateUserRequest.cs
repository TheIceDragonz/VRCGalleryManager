...
namespace VRChat.API.Model
{
    ...
    public partial class UpdateUserRequest : IEquatable<UpdateUserRequest>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // ProfilePicOverride (string) minLength
            if (this.ProfilePicOverride != null && this.ProfilePicOverride.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProfilePicOverride, length must be greater than 0.", new[] { "ProfilePicOverride" });
            }
