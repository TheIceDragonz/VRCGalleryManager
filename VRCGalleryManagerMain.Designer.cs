...
namespace VRCGalleryManager
{
    partial class MainPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            _switchGallery = new RoundedButton();
            ...
            // _switchGallery
            // 
            _switchGallery.BackColor = Color.FromArgb(7, 36, 43);
            _switchGallery.BackgroundColor = Color.FromArgb(7, 36, 43);
            _switchGallery.BorderColor = Color.FromArgb(5, 55, 66);
            _switchGallery.BorderRadius = 10;
            _switchGallery.BorderSize = 2;
            _switchGallery.Dock = DockStyle.Bottom;
            _switchGallery.FlatAppearance.BorderSize = 0;
            ...
            _switchGallery.TextColor = Color.FromArgb(106, 227, 249);
            _switchGallery.UseVisualStyleBackColor = false;
            _switchGallery.Click += _switchGallery_Click;
            // 
            // _switchSettings
            // 
            ...
            profileBanner.Location = new Point(15, 94);
            ...
            profileIcon.BorderRadiusBottomLeft = 0;
            profileIcon.BorderRadiusBottomRight = 0;
            profileIcon.BorderRadiusTopLeft = 0;
            profileIcon.BorderRadiusTopRight = 0;
            profileIcon.BorderSize = 0;
            profileIcon.ImageLocation = "";
            profileIcon.Location = new Point(15, 146);
            ...
            profileIcon.UseMaxRoundness = true;
            ...
            badgeBox1.BorderRadiusBottomLeft = 0;
            badgeBox1.BorderRadiusBottomRight = 0;
            badgeBox1.BorderRadiusTopLeft = 0;
            badgeBox1.BorderRadiusTopRight = 0;
            badgeBox1.BorderSize = 0;
            badgeBox1.Location = new Point(91, 180);
            ...
            badgeBox1.UseMaxRoundness = true;
            ...
            badgeBox2.BorderRadiusBottomLeft = 0;
            badgeBox2.BorderRadiusBottomRight = 0;
            badgeBox2.BorderRadiusTopLeft = 0;
            badgeBox2.BorderRadiusTopRight = 0;
            badgeBox2.BorderSize = 0;
            badgeBox2.Location = new Point(136, 180);
            ...
            badgeBox2.UseMaxRoundness = true;
            ...
            badgeBox3.BorderRadiusBottomLeft = 0;
            badgeBox3.BorderRadiusBottomRight = 0;
            badgeBox3.BorderRadiusTopLeft = 0;
            badgeBox3.BorderRadiusTopRight = 0;
            badgeBox3.BorderSize = 0;
            badgeBox3.Location = new Point(181, 180);
            ...
            badgeBox3.UseMaxRoundness = true;
            badgeBox3.Visible = false;
            // 
            // userNameLabel
            // 
            userNameLabel.AccessibleName = "";
            userNameLabel.BackColor = Color.FromArgb(15, 17, 19);
            userNameLabel.Cursor = Cursors.Hand;
            userNameLabel.Font = new Font("Segoe UI Black", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            userNameLabel.ForeColor = Color.FromArgb(106, 227, 249);
            userNameLabel.Location = new Point(15, 68);
            userNameLabel.Name = "userNameLabel";
            userNameLabel.Size = new Size(196, 25);
        ...
        private RoundedButton _switchGallery;
